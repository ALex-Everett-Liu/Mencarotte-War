...
- ## comment
    ...
    - 看了下，还是用我的 [[Gyroscope]] 吧。年底的 year recap 颜值非常高
        - 当然，我[已经在心里骂了] Moves 无数遍了，非常糟心。Gyroscope 据说要[开始做这个功能了]，可以期待。
    - 因为留下的是 [api 对应的]微博原链接，[删除微博后]的确无法打开。如果想避免，可以不删除微博，[批量设置为][仅自己查看]。
其实微博这块[我遇到的最大困扰]是[提供给 IFTTT 的接口]不稳定，偶尔会罢工，Zapier 也未支持微博，暂时没有很好的解决方案。

...
- [[Fourier-transform infrared spectroscopy (FTIR)]]; [[Fourier-transform spectroscopy]]; FTIR spectroscopy; FT-IR spectroscopy; FT-IR instrument; FT spectrometer
    - FT-NIR Spectroscopy;
...
- [光源/照明系统]([[light source]])
    - [He-Ne Laser]([[helium–neon laser]]) (632.8 nm)
...
211012-10:45
    ...
    - 红外光源 -[光阑转轮]([[diaphragm]]) ([[circular aperture stop]] (imaged on [[objective mirror]])) -滤波片轮 (IVU) -- 验证轮
- 分类
    - 色散/分光型 -- 单色光
...
211012-11:26
        - [滤波技术]-实现[固体检测器](((Sl7QfOBHa)))对[待测组分][特征吸收波长的选择] -- 将[空间单光路]转变为[时间双光路]。

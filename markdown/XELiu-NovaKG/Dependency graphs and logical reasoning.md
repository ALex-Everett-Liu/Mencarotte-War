...
- Besides [reasoning and argument], [dependency graphs] have applications in [[education]], [self-directed learning], and general [[decision-making]]. Even a very [[complicated project]] can be [traced backwards to]([[trace]]) [a number of smaller tasks]([[task]]). ^^The user can see the [[tradeoff]]s involved in each [[pathway]], map out [which route is the fastest](((jqBpyx9m8))), and which path might [bring them closer to] [other interesting goals]([[goal]]).^^ As the student [marks their progress], they can [discover new projects and pathways] which [make use of] [the skills they have acquired](((cbU9p8_tP))).
201124-18:46
- The problems of [[prose]] [apply even in the domain of] [[mathematical proof]]s, see Lamport’s [How to write a 21st Century Proof]”

...
211230-18:24
    - **2 改造前CEMS系统存在的问题**
        ...
        - [探头过滤器][过滤孔径]大，过滤效果差，部分[细小颗粒物][无法过滤掉]，进入[取样管路]后[附着在取样管壁上]，造成[管路阻塞]，减小了[抽气量]，造成分析仪[测量数据]不准确，甚至[流量低至报警值]后，**CEMS 系统将[停止工作]，从而引起[烟气参数异常]，严重影响到[上传环保部门]的烟气数据准确性。**样气中[含有的颗粒物]进入分析仪后，[对分析仪的损害]也是很大的，[轻则影响][测量传感器]的准确度，导致烟气数据不准确，重则[损坏分析仪]，导致[巨大经济损失]和环保影响。

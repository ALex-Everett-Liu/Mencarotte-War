- In classical mechanics, a harmonic oscillator is a system that, when displaced from its [[equilibrium position]], experiences a [[restoring force]] F [proportional to the displacement]([[displacement]]) x:
